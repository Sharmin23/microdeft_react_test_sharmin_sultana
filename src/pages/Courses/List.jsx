  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden">
      <div className="relative">
        ...
        <span className="absolute top-2 left-2 bg-pink-500 text-white text-sm font-semibold px-3 py-1 rounded-full">
          {badge}
        </span>
      </div>
      <div className="p-4">
        ...
        <button className="w-full bg-indigo-500 text-white py-2 rounded-md font-semibold hover:bg-indigo-600 transition">
          View Details
        </button>
      </div>
    </div>
  ...
  const courses = [
    {
      ...
      badge: 'Failed',
      image:
        'https://via.placeholder.com/400x300', // Replace with actual image URL
    },
    {
      title: 'Creational Design Patterns in Java/J2EE',
      description:
